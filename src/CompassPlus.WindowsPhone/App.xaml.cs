    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            if (Debugger.IsAttached)
            {
                ...
                this.Host.Settings.EnableFrameRateCounter = true;
        ...
        {
            var settings = new IsolatedSettings();
            var value = settings.Get(StoreKeyConstants.CollectErrors);
            if (string.IsNullOrWhiteSpace(value))
            {
                value = Constants.DefaultCollectErrors.ToString();
            }
            var collect = Utils.TryParse<bool>(value, Boolean.TryParse);
            if (collect)
            {
        ...
        {
            new Setup(new IsolatedSettings()).LoadDefaultSettings().WithCurrentCulture();
        }
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            ...
            e.Handled = true; // TODO: For now handled to ensure that error log completes log
